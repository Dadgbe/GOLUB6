...
async function main() {
    ...
    client.once('ready', () => {
        ...
        client.user.setActivity('Реальные Пацаны 13 сезон 5 серия', { type: ActivityType.Watching});
    });
    ...
    client.on("interactionCreate", async interaction => {
        ...
        client.user.setActivity("Общается с" + interaction.user.tag, { type: ActivityType.CUSTOM_STATUS });
    ...
    async function ask_Interaction_Handler(interaction) {
        ...
        try {
            ...
            askQuestion(question, interaction, async (content) => {
                ...
                client.user.setActivity('Смотрит Реальные Пацаны 13 сезон 5 серия', { type: ActivityType.Watching});
                // TODO: send to DB
            })
        } catch (e) {
